...
#define x64_mov_rax__esp_ \
EMIT(0x48) EMIT(0x8B) EMIT(0x04) EMIT(0x24)

#define x64_mov_rbx__esp_ \
EMIT(0x48) EMIT(0x8B) EMIT(0x1C) EMIT(0x24)

#define x64_mov_rcx__esp_ \
EMIT(0x48) EMIT(0x8B) EMIT(0x0C) EMIT(0x24)

#define x64_mov_rdx__esp_ \
EMIT(0x48) EMIT(0x8B) EMIT(0x14) EMIT(0x24)

#define x64_mov_r8__esp_ \
EMIT(0x4C) EMIT(0x8B) EMIT(0x04) EMIT(0x24)

#define x64_mov_r9__esp_ \
EMIT(0x4C) EMIT(0x8B) EMIT(0x0C) EMIT(0x24)

#define x64_mov_rbp_rsp \
EMIT(0x48) EMIT(0x8B) EMIT(0xEC)
